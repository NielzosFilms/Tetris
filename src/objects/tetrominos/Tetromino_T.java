...
public class Tetromino_T extends GameObject implements Tetromino {
	private final Color COLOR = ColorPalette.tetromino_T.color;
	private final Color BORDER_COLOR = ColorPalette.tetromino_T_border.color;
